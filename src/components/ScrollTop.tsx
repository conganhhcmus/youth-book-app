...
const ScrollToTop = () => {
    ...
    return (
        <button
            ...
            className={`fixed bottom-6 right-6 hidden aspect-square -rotate-45 items-center justify-center rounded-full border bg-white p-2 shadow-md transition-all duration-200 active:scale-75 dark:border-gray-700 dark:bg-gray-900 dark:text-white sm:bottom-6 sm:right-6 lg:flex ${
                isShow ? ' pointer-events-auto opacity-100' : ' pointer-events-none translate-y-3 opacity-0'
            }`}>
            <svg
